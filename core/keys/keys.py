...
def setup_default_alphabet():
    ...
    initial_default_alphabet = "arch bat crunch drank each fail gust hish sit jape kate look made near osk prime quilt root sun trap urge vest whisk plex yank zorch".split()

    # initial_default_alphabet = "arch bat crunch drank each fine gust hish sit jank crunch look made near odd pit quench red sun trap urge vest whale plex yank zip".split()
